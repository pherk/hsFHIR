...
%%
      <<"Extension">> => {<<"Element">>,
          [{<<"value">>,
            ...
            {<<"valueContactDetail">>, {{metadata, <<"ContactDetail">>}, optional}},
            {<<"valueContributor">>, {{metadata, <<"Contributor">>}, optional}},
            {<<"valueDataRequirement">>, {{metadata, <<"DataRequirement">>}, optional}},
            {<<"valueExpression">>, {{metadata, <<"Expression">>}, optional}},
            {<<"valueParameterDefinition">>, {{metadata, <<"ParameterDefinition">>}, optional}},
...
%%
    , <<"Dosage">> => {<<"BackboneElement">>,
            ...
            {<<"asNeeded">>, [{<<"asNeededBoolean">>, {{primitive, <<"boolean">>}, optional}},
...
%%
    , <<"UsageContext">> => {<<"Element">>,
            ...
            {<<"value">>, [ {<<"valueCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
...
%%
    , <<"ElementDefinition">> => {<<"BackboneElement">>,
            ...
            {<<"default">>, [{<<"defaultValueBase64Binary">>, {{primitive, <<"base64Binary">>}, optional}},
                ...
                {<<"defaultValueContactDetail">>, {{metadata, <<"ContactDetail">>}, optional}},
                {<<"defaultValueContributor">>, {{metadata, <<"Contributor">>}, optional}},
                {<<"defaultValueDataRequirement">>, {{metadata, <<"DataRequirement">>}, optional}},
                {<<"defaultValueExpression">>, {{metadata, <<"Expression">>}, optional}},
                {<<"defaultValueParameterDefinition">>, {{metadata, <<"ParameterDefinition">>}, optional}},
                {<<"defaultValueRelatedArtifact">>, {{metadata, <<"RelatedArtifact">>}, optional}},
                {<<"defaultValueTriggerDefinition">>, {{metadata, <<"TriggerDefinition">>}, optional}},
                {<<"defaultValueUsageContext">>, {{metadata, <<"UsageContext">>}, optional}},
            ...
            {<<"fixed">>, [{<<"fixedBase64Binary">>, {{primitive, <<"base64Binary">>}, optional}},
                ...
                {<<"fixedContactDetail">>, {{metadata, <<"ContactDetail">>}, optional}},
                {<<"fixedContributor">>, {{metadata, <<"Contributor">>}, optional}},
                {<<"fixedDataRequirement">>, {{metadata, <<"DataRequirement">>}, optional}},
                {<<"fixedExpression">>, {{metadata, <<"Expression">>}, optional}},
                {<<"fixedParameterDefinition">>, {{metadata, <<"ParameterDefinition">>}, optional}},
                {<<"fixedRelatedArtifact">>, {{metadata, <<"RelatedArtifact">>}, optional}},
                {<<"fixedTriggerDefinition">>, {{metadata, <<"TriggerDefinition">>}, optional}},
                {<<"fixedUsageContext">>, {{metadata, <<"UsageContext">>}, optional}},
                {<<"fixedDosage">>, {{bbelement, <<"Dosage">>}, optional}}]},
            {<<"pattern">>, [{<<"patternBase64Binary">>, {{primitive, <<"base64Binary">>}, optional}},
                ...
                {<<"patternContactDetail">>, {{metadata, <<"ContactDetail">>}, optional}},
                {<<"patternContributor">>, {{metadata, <<"Contributor">>}, optional}},
                {<<"patternDataRequirement">>, {{metadata, <<"DataRequirement">>}, optional}},
                {<<"patternExpression">>, {{metadata, <<"Expression">>}, optional}},
                {<<"patternParameterDefinition">>, {{metadata, <<"ParameterDefinition">>}, optional}},
                {<<"patternRelatedArtifact">>, {{metadata, <<"RelatedArtifact">>}, optional}},
                {<<"patternTriggerDefinition">>, {{metadata, <<"TriggerDefinition">>}, optional}},
                {<<"patternUsageContext">>, {{metadata, <<"UsageContext">>}, optional}},
                {<<"patternDosage">>, {{bbelement, <<"Dosage">>}, optional}}]},
            {<<"example">>, {{bbelement, <<"ElementDefinition.Example">>}, list}},
            {<<"min">>, [{<<"minValueDate">>, {{primitive, <<"date">>}, optional}},
            ...
            {<<"max">>, [{<<"maxValueDate">>, {{primitive, <<"date">>}, optional}},
...
%%
    , <<"ElementDefinition.Example">> => {<<"BackboneElement">>,
            ...
            {<<"value">>, [{<<"valueBase64Binary">>, {{primitive, <<"base64Binary">>}, required}},
                ...
                {<<"valueContactDetail">>, {{metadata, <<"ContactDetail">>}, required}},
                {<<"valueContributor">>, {{metadata, <<"Contributor">>}, required}},
                {<<"valueDataRequirement">>, {{metadata, <<"DataRequirement">>}, required}},
                {<<"valueExpression">>, {{metadata, <<"Expression">>}, required}},
                {<<"valueParameterDefinition">>, {{metadata, <<"ParameterDefinition">>}, required}},
                {<<"valueRelatedArtifact">>, {{metadata, <<"RelatedArtifact">>}, required}},
                {<<"valueTriggerDefinition">>, {{metadata, <<"TriggerDefinition">>}, required}},
                {<<"valueUsageContext">>, {{metadata, <<"UsageContext">>}, required}},
...
%%
    , <<"DomainResource">> => {<<"Resource">>,
            ...
            {<<"contained">>, {{resource, <<"ResourceContainer">>}, list}},
            {<<"extension">>, {{extension, <<"Extension">>}, list}},
            {<<"modifierExtension">>, {{extension, <<"Extension">>}, list}}
            ],
            [],
...
%%
    , <<"Resource">> => {<<"">>,
            ...
            {<<"language">>, {{code, <<"language">>}, optional}}
            ],
            [],
            []
} 
...
%%
    , <<"AllergyIntolerance">> => {<<"DomainResource">>,
            ...
            {<<"encounter">>, {{special, <<"Reference">>}, optional}},
            {<<"onset">>, [ {<<"onsetDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"AuditEvent.Detail">> => {<<"BackboneElement">>,
            ...
            {<<"value">>, [{<<"valueString">>, {{primitive, <<"string">>}, required}},
...
%%
    , <<"Binary">> => {<<"Resource">>,
            [
            {<<"contentType">>, {{code, <<"mimetype">>}, required}},
...
%%
    , <<"BiologicallyDerivedProduct.Collection">> => {<<"BackboneElement">>,
            ...
            {<<"collected">>, [{<<"collectedDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"BiologicallyDerivedProduct.Processing">> => {<<"BackboneElement">>,
            ...
            {<<"time">>, [{<<"timeDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"Bundle.Entry">> => {<<"BackboneElement">>,
            ...
            {<<"resource">>, {{resource, <<"ResourceContainer">>}, optional}},
...
%%
    , <<"Bundle.Response">> => {<<"BackboneElement">>,
            ...
            {<<"outcome">>, {{resource, <<"ResourceContainer">>}, optional}}
            ],
            [],
            []
} 
...
%%
    , <<"CarePlan.Detail">> => {<<"BackboneElement">>,
            ...
            {<<"doNotPerform">>, {{primitive, <<"boolean">>}, optional}},
            {<<"scheduled">>, [{<<"scheduledTiming">>, {{bbelement, <<"Timing">>}, optional}},
                {<<"scheduledPeriod">>, {{complex, <<"Period">>}, optional}},
                {<<"scheduledString">>, {{primitive, <<"string">>}, optional}}]},
            {<<"location">>, {{special, <<"Reference">>}, optional}},
            {<<"performer">>, {{special, <<"Reference">>}, list}},
            {<<"product">>, [{<<"productCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
...
%%
    , <<"ChargeItem">> => {<<"DomainResource">>,
            ...
            {<<"occurence">>, [{<<"occurrenceDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"Claim.SupportingInfo">> => {<<"BackboneElement">>,
            ...
            {<<"code">>, {{complex, <<"CodeableConcept">>}, optional}},
            {<<"timing">>, [ {<<"timingDate">>, {{primitive, <<"date">>}, optional}},
                             {<<"timingPeriod">>, {{complex, <<"Period">>}, optional}}]},
            {<<"value">>, [ {<<"valueBoolean">>, {{primitive, <<"boolean">>}, optional}},
                            {<<"valueString">>, {{primitive, <<"string">>}, optional}},
                            {<<"valueQuantity">>, {{complex, <<"Quantity">>}, optional}},
                            {<<"valueAttachment">>, {{complex, <<"Attachment">>}, optional}},
                            {<<"valueReference">>, {{special, <<"Reference">>}, optional}}]},
...
%%
    , <<"Claim.Diagnosis">> => {<<"BackboneElement">>,
            [
            {<<"sequence">>, {{primitive, <<"positiveInt">>}, required}},
            {<<"diagnosis">>, [ {<<"diagnosisCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
...
%%
    , <<"Claim.Procedure">> => {<<"BackboneElement">>,
            ...
            {<<"type">>, {{complex, <<"CodeableConcept">>}, list}},
            {<<"date">>, {{primitive, <<"dateTime">>}, optional}},
            {<<"procedure">>, [ {<<"procedureCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
...
%%
    , <<"Claim.Accident">> => {<<"BackboneElement">>,
            ...
            {<<"type">>, {{complex, <<"CodeableConcept">>}, optional}},
            {<<"location">>, [ {<<"locationAddress">>, {{complex, <<"Address">>}, optional}},
...
%%
    , <<"Claim.Item">> => {<<"BackboneElement">>,
            ...
            {<<"serviced">>, [ {<<"servicedDate">>, {{primitive, <<"date">>}, optional}},
                               {<<"servicedPeriod">>, {{complex, <<"Period">>}, optional}}]},
            {<<"location">>, [ {<<"locationCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
...
%%
    , <<"ClinicalImpression">> => {<<"DomainResource">>,
            ...
            {<<"subject">>, {{special, <<"Reference">>}, required}},
            {<<"encounter">>, {{special, <<"Reference">>}, optional}},
            {<<"effective">>, [{<<"effectiveDateTime">>, {{primitive, <<"dateTime">>}, optional}},
                {<<"effectivePeriod">>, {{complex, <<"Period">>}, optional}}]},
            {<<"date">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"CodeSystem.Property1">> => {<<"BackboneElement">>,
            [
            {<<"code">>, {{primitive, <<"code">>}, required}},
            {<<"value">>, [{<<"valueCode">>,{{primitive, <<"code">>}, required}},
                           {<<"valueCoding">>, {{complex, <<"Coding">>}, required}},
                           {<<"valueString">>, {{primitive, <<"string">>}, required}},
                           {<<"valueInteger">>, {{primitive, <<"integer">>}, required}},
                           {<<"valueBoolean">>, {{primitive, <<"boolean">>}, required}},
...
%%
    , <<"Communication.Payload">> => {<<"BackboneElement">>,
            [
            {<<"content">>, [{<<"contentString">>, {{primitive, <<"string">>}, required}},
...
%%
    , <<"Composition.RelatesTo">> => {<<"BackboneElement">>,
            ...
            {<<"target">>, [{<<"targetIdentifier">>, {{complex, <<"Identifier">>}, required}},
...
%%
    , <<"ConceptMap">> => {<<"DomainResource">>,
            ...
            {<<"purpose">>, {{primitive, <<"markdown">>}, optional}},
            {<<"copyright">>, {{primitive, <<"markdown">>}, optional}},
            {<<"source">>, [{<<"sourceUri">>, {{primitive, <<"uri">>}, optional}},
                {<<"sourceCanonical">>, {{primitive, <<"canonical">>}, optional}}]},
            {<<"target">>, [{<<"targetUri">>, {{primitive, <<"uri">>}, optional}},
...
%%
    , <<"Condition">> => {<<"DomainResource">>,
            ...
            {<<"onset">>, [ {<<"onsetDateTime">>, {{primitive, <<"dateTime">>}, optional}},
                            ...
                            {<<"onsetRange">>, {{complex, <<"Range">>}, optional}},
                            {<<"onsetString">>, {{primitive, <<"string">>}, optional}}]},
            {<<"abatement">>, [ {<<"abatementDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"Consent">> => {<<"DomainResource">>,
            ...
            {<<"source">>, [ {<<"sourceAttachment">>, {{complex, <<"Attachment">>}, optional}},
...
%%
    , <<"Contract">> => {<<"DomainResource">>,
            ...
            {<<"topic">>, [{<<"topicCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
            ...
            {<<"legally">>, [{<<"legallyBindingAttachment">>, {{complex, <<"Attachment">>}, optional}},
...
%%
    , <<"Contract.Answer">> => {<<"BackboneElement">>,
            [
            {<<"value">>, [{<<"valueBoolean">>, {{primitive, <<"boolean">>}, required}},
                {<<"valueDecimal">>, {{primitive, <<"decimal">>}, required}},
                {<<"valueInteger">>, {{primitive, <<"integer">>}, required}},
                {<<"valueDate">>, {{primitive, <<"date">>}, required}},
                {<<"valueDateTime">>, {{primitive, <<"dateTime">>}, required}},
...
%%
    , <<"Contract.ValuedItem">> => {<<"BackboneElement">>,
            [
            {<<"entity">>, [{<<"entityCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
...
%%
    , <<"Contract.Action">> => {<<"BackboneElement">>,
            ...
            {<<"occurrence">>, [{<<"occurrenceDateTime">>, {{primitive, <<"dateTime">>}, optional}},
                {<<"occurrencePeriod">>, {{complex, <<"Period">>}, optional}},
                {<<"occurrenceTiming">>, {{bbelement, <<"Timing">>}, optional}}]},
...
%%
    , <<"Contract.Friendly">> => {<<"BackboneElement">>,
            [
            {<<"content">>, [{<<"contentAttachment">>, {{complex, <<"Attachment">>}, required}},
                {<<"contentReference">>, {{special, <<"Reference">>}, required}}]}
            ],
            [],
            [
...
%%
    , <<"Coverage.CostToBeneficiary">> => {<<"BackboneElement">>,
            [
            {<<"type">>, {{complex, <<"CodeableConcept">>}, optional}},
            {<<"value">>, [ {<<"valueQuantity">>, {{complex, <<"Quantity">>}, required}},
                            {<<"valueMoney">>, {{complex, <<"Money">>}, required}}]},
...
%%
    , <<"CoverageEligibilityRequest.Diagnosis">> => {<<"BackboneElement">>,
            [
            {<<"diagnosis">>, [{<<"diagnosisCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
...
%%
    , <<"CoverageEligibilityResponse.Benefit">> => {<<"BackboneElement">>,
            [
            {<<"type">>, {{complex, <<"CodeableConcept">>}, required}},
            {<<"allowed">>, [{<<"allowedUnsignedInt">>, {{primitive, <<"unsignedInt">>}, optional}},
                {<<"allowedString">>, {{primitive, <<"string">>}, optional}},
                {<<"allowedMoney">>, {{complex, <<"Money">>}, optional}}]},
            {<<"used">>, [{<<"usedUnsignedInt">>, {{primitive, <<"unsignedInt">>}, optional}},
...
%%
    , <<"DetectedIssue">> => {<<"DomainResource">>,
            ...
            {<<"patient">>, {{special, <<"Reference">>}, optional}},
            {<<"identified">>, [{<<"identifiedDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"Device.UdiCarrier">> => {<<"BackboneElement">>,
            ...
            {<<"carrier">>, [{<<"carrierAIDC">>, {{primitive, <<"base64Binary">>}, optional}},
...
%%
    , <<"Device.Property">> => {<<"BackboneElement">>,
            [
            {<<"type">>, {{complex, <<"CodeableConcept">>}, required}},
            {<<"value">>, [{<<"valueQuantity">>, {{complex, <<"Quantity">>}, list}},
...
%%
    , <<"DeviceDefinition">> => {<<"DomainResource">>,
            ...
            {<<"manufacturer">>, [{<<"manufacturerString">>, {{primitive, <<"string">>}, optional}},
...
%%
    , <<"DeviceRequest">> => {<<"DomainResource">>,
            ...
            {<<"priority">>, {{code, <<"requestpriority">>}, optional}},
            {<<"code">>, [{<<"codeReference">>, {{special, <<"Reference">>}, required}},
...
%%
    , <<"DeviceRequest.Parameter">> => {<<"BackboneElement">>,
            [
            {<<"code">>, {{complex, <<"CodeableConcept">>}, optional}},
            {<<"value">>, [{<<"valueCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
                {<<"valueQuantity">>, {{complex, <<"Quantity">>}, optional}},
                {<<"valueRange">>, {{complex, <<"Range">>}, optional}},
                {<<"valueBoolean">>, {{primitive, <<"boolean">>}, optional}}]}
            ],
...
%%
    , <<"EvidenceVariable.Characteristic">> => {<<"BackboneElement">>,
            [
            {<<"description">>, {{primitive, <<"string">>}, optional}},
            {<<"definition">>, [{<<"definitionReference">>, {{special, <<"Reference">>}, required}},
                {<<"definitionCanonical">>, {{primitive, <<"canonical">>}, required}},
                {<<"definitionCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
                {<<"definitionExpression">>, {{metadata, <<"Expression">>}, required}},
                {<<"definitionDataRequirement">>, {{metadata, <<"DataRequirement">>}, required}},
                {<<"definitionTriggerDefinition">>, {{metadata, <<"TriggerDefinition">>}, required}}]},
            {<<"usageContext">>, {{metadata, <<"UsageContext">>}, list}},
            {<<"exclude">>, {{primitive, <<"boolean">>}, optional}},
            {<<"participantEffective">>, [{<<"participantEffectiveDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"FamilyMemberHistory.Condition">> => {<<"BackboneElement">>,
            ...
            {<<"onset">>, [{<<"onsetAge">>, {{complex, <<"Age">>}, optional}},
                {<<"onsetRange">>, {{complex, <<"Range">>}, optional}},
                {<<"onsetPeriod">>, {{complex, <<"Period">>}, optional}},
                {<<"onsetString">>, {{primitive, <<"string">>}, optional}}]},
            {<<"note">>, {{complex, <<"Annotation">>}, list}}
...
%%
    , <<"Goal">> => {<<"DomainResource">>,
            ...
            {<<"subject">>, {{special, <<"Reference">>}, required}},
            {<<"start">>, [ {<<"startDate">>, {{primitive, <<"date">>}, optional}},
...
%%
    , <<"Goal.Target">> => {<<"BackboneElement">>,
            ...
            {<<"detail">>, [ {<<"detailQuantity">>, {{complex, <<"Quantity">>}, optional}},
            ...
            {<<"due">>, [ {<<"dueDate">>, {{primitive, <<"date">>}, optional}},
...
%%
    , <<"GuidanceResponse">> => {<<"DomainResource">>,
            ...
            {<<"identifier">>, {{complex, <<"Identifier">>}, list}},
            {<<"module">>, [{<<"moduleUri">>, {{primitive, <<"uri">>}, required}},
...
%%
    , <<"Immunization">> => {<<"DomainResource">>,
            ...
            {<<"patient">>, {{special, <<"Reference">>}, required}},
            {<<"encounter">>, {{special, <<"Reference">>}, optional}},
            {<<"occurrence">>, [ {<<"occurrenceDateTime">>, {{primitive, <<"dateTime">>}, required}},
...
%%
    , <<"Immunization.ProtocolApplied">> => {<<"BackboneElement">>,
            ...
            {<<"doseNumber">>, [ {<<"doseNumberPositiveInt">>, {{primitive, <<"positiveInt">>}, required}},
                                 {<<"doseNumberString">>, {{primitive, <<"string">>}, required}}]},
            {<<"seriesDoses">>, [ {<<"seriesDosesPositiveInt">>, {{primitive, <<"positiveInt">>}, optional}},
...
%%
    , <<"ImmunizationEvaluation">> => {<<"DomainResource">>,
            ...
            {<<"description">>, {{primitive, <<"string">>}, optional}},
            {<<"series">>, {{primitive, <<"string">>}, optional}},
            {<<"doseNumber">>, [{<<"doseNumberPositiveInt">>, {{primitive, <<"positiveInt">>}, optional}},
...
%%
    , <<"ImplementationGuide.Resource">> => {<<"BackboneElement">>,
            ...
            {<<"name">>, {{primitive, <<"string">>}, optional}},
            {<<"description">>, {{primitive, <<"string">>}, optional}},
            {<<"example">>, [{<<"exampleBoolean">>, {{primitive, <<"boolean">>}, optional}},
...
%%
    , <<"ImplementationGuide.Page">> => {<<"BackboneElement">>,
            [
            {<<"name">>, [{<<"nameUrl">>, {{primitive, <<"url">>}, required}},
...
%%
    , <<"Invoice.LineItem">> => {<<"BackboneElement">>,
            ...
            {<<"chargeItem">>, [{<<"chargeItemReference">>, {{special, <<"Reference">>}, required}},
...
%%
    , <<"Measure">> => {<<"DomainResource">>,
            ...
            {<<"status">>, {{code, <<"publicationstatus">>}, required}},
            {<<"experimental">>, {{primitive, <<"boolean">>}, optional}},
            {<<"subjct">>, [{<<"subjectCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
                {<<"subjectReference">>, {{special, <<"Reference">>}, optional}}]},
            {<<"date">>, {{primitive, <<"dateTime">>}, optional}},
            {<<"publisher">>, {{primitive, <<"string">>}, optional}},
            {<<"contact">>, {{complex, <<"ContactDetail">>}, list}},
...
%%
    , <<"Media">> => {<<"DomainResource">>,
            ...
            {<<"subject">>, {{special, <<"Reference">>}, optional}},
            {<<"encounter">>, {{special, <<"Reference">>}, optional}},
            {<<"created">>, [{<<"createdDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"Medication.Ingredient">> => {<<"BackboneElement">>,
            [
            {<<"item">>, [{<<"itemCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
...
%%
    , <<"MedicationAdministration">> => {<<"DomainResource">>,
            ...
            {<<"statusReason">>, {{complex, <<"CodeableConcept">>}, list}},
            {<<"category">>, {{complex, <<"CodeableConcept">>}, optional}},
            {<<"medication">>, [{<<"medicationCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
                {<<"medicationReference">>, {{special, <<"Reference">>}, required}}]},
            {<<"subject">>, {{special, <<"Reference">>}, required}},
            {<<"context">>, {{special, <<"Reference">>}, optional}},
            {<<"supportingInformation">>, {{special, <<"Reference">>}, list}},
            {<<"effective">>, [{<<"effectiveDateTime">>, {{primitive, <<"dateTime">>}, required}},
...
%%
    , <<"MedicationDispense">> => {<<"DomainResource">>,
            ...
            {<<"partOf">>, {{special, <<"Reference">>}, list}},
            {<<"status">>, {{primitive, <<"code">>}, required}},
            {<<"statusReason">>, [{<<"statusReasonCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
...
%%
    , <<"MedicationKnowledge.AdministrationGuidelines">> => {<<"BackboneElement">>,
            ...
            {<<"indication">>, [{<<"indicationCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
...
%%
    , <<"MedicationKnowledge.PatientCharacteristics">> => {<<"BackboneElement">>,
            [
            {<<"characteristic">>, [{<<"characteristicCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
...
%%
    , <<"MedicationRequest">> => {<<"DomainResource">>,
            ...
            {<<"priority">>, {{code, <<"requestpriority">>}, optional}},
            {<<"doNotPerform">>, {{primitive, <<"boolean">>}, optional}},
            {<<"reported">>, [ {<<"reportedBoolean">>, {{primitive, <<"boolean">>}, optional}},
...
%%
    , <<"MedicationRequest.Substitution">> => {<<"BackboneElement">>,
            [
            {<<"allowed">>, [{<<"allowedBoolean">>, {{primitive, <<"boolean">>}, required}},
...
%%
    , <<"MedicinalProductAuthorization.Procedure">> => {<<"BackboneElement">>,
            ...
            {<<"identifier">>, {{complex, <<"Identifier">>}, optional}},
            {<<"type">>, {{complex, <<"CodeableConcept">>}, required}},
            {<<"date">>, [{<<"datePeriod">>, {{complex, <<"Period">>}, optional}},
...
%%
    , <<"MedicinalProductInteraction.Interactant">> => {<<"BackboneElement">>,
            [
            {<<"item">>, [{<<"itemReference">>, {{special, <<"Reference">>}, required}},
...
%%
    , <<"MessageDefinition">> => {<<"DomainResource">>,
            ...
            {<<"event">>, [{<<"eventCoding">>, {{complex, <<"Coding">>}, required}},
...
%%
    , <<"NutritionOrder.Administration">> => {<<"BackboneElement">>,
            ...
            {<<"quantity">>, {{complex, <<"Quantity">>}, optional}},
            {<<"rate">>, [{<<"rateQuantity">>, {{complex, <<"Quantity">>}, optional}},
...
%%
    , <<"Observation">> => {<<"DomainResource">>,
            ...
            {<<"issued">>, {{primitive, <<"instant">>}, optional}},
            {<<"performer">>, {{special, <<"Reference">>}, list}},
            {<<"value">>, [ {<<"valueQuantity">>, {{complex, <<"Quantity">>}, optional}},
                            {<<"valueCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
                            {<<"valueString">>, {{primitive, <<"string">>}, optional}},
                            {<<"valueBoolean">>, {{primitive, <<"boolean">>}, optional}},
                            {<<"valueInteger">>, {{primitive, <<"integer">>}, optional}},
...
%%
    , <<"Parameters.Parameter">> => {<<"BackboneElement">>,
            [
            {<<"name">>, {{primitive, <<"string">>}, required}},
            {<<"value">>, [{<<"valueBase64Binary">>, {{primitive, <<"base64Binary">>}, optional}},
                {<<"valueBoolean">>, {{primitive, <<"boolean">>}, optional}},
                {<<"valueCanonical">>, {{primitive, <<"canonical">>}, optional}},
                {<<"valueCode">>, {{primitive, <<"code">>}, optional}},
                {<<"valueDate">>, {{primitive, <<"date">>}, optional}},
...
%%
    , <<"Patient">> => {<<"DomainResource">>,
            ...
            {<<"multipleBirth">>, [ {<<"multipleBirthBoolean">>, {{primitive, <<"boolean">>}, optional}},
...
%%
    , <<"PlanDefinition.Action">> => {<<"BackboneElement">>,
            ...
            {<<"subject">>, [{<<"subjectCodeableConcept">>, {{complex, <<"CodeableConcept">>}, optional}},
                             {<<"subjectReference">>, {{special, <<"Reference">>}, optional}}]},
            {<<"trigger">>, {{metadata, <<"TriggerDefinition">>}, list}},
            {<<"condition">>, {{bbelement, <<"PlanDefinition.Condition">>}, list}},
            {<<"input">>, {{metadata, <<"DataRequirement">>}, list}},
            {<<"output">>, {{metadata, <<"DataRequirement">>}, list}},
            {<<"relatedAction">>, {{bbelement, <<"PlanDefinition.RelatedAction">>}, list}},
            {<<"timing">>, [{<<"timingDateTime">>, {{primitive, <<"dateTime">>}, optional}},
                            {<<"timingAge">>, {{complex, <<"Age">>}, optional}},
                            {<<"timingPeriod">>, {{complex, <<"Period">>}, optional}},
                            {<<"timingDuration">>, {{complex, <<"Duration">>}, optional}},
                            {<<"timingRange">>, {{complex, <<"Range">>}, optional}},
            ...
            {<<"definition">>,[{<<"definitionCanonical">>, {{primitive, <<"canonical">>}, optional}},
...
%%
    , <<"PlanDefinition.RelatedAction">> => {<<"BackboneElement">>,
            ...
            {<<"offset">>, [ {<<"offsetDuration">>, {{complex, <<"Duration">>}, optional}},
...
%%
    , <<"Procedure">> => {<<"DomainResource">>,
            ...
            {<<"subject">>, {{special, <<"Reference">>}, required}},
            {<<"encounter">>, {{special, <<"Reference">>}, optional}},
            {<<"performed">>, [{<<"performedDateTime">>, {{primitive, <<"dateTime">>}, optional}},
...
%%
    , <<"Questionnaire.EnableWhen">> => {<<"BackboneElement">>,
            ...
            {<<"answer">>, [{<<"answerBoolean">>, {{primitive, <<"boolean">>}, required}},
...
%%
    , <<"Questionnaire.AnswerOption">> => {<<"BackboneElement">>,
            [
            {<<"value">>, [{<<"valueInteger">>, {{primitive, <<"integer">>}, required}},
                {<<"valueDate">>, {{primitive, <<"date">>}, required}},
                {<<"valueTime">>, {{primitive, <<"time">>}, required}},
                {<<"valueString">>, {{primitive, <<"string">>}, required}},
                {<<"valueCoding">>, {{complex, <<"Coding">>}, required}},
...
%%
    , <<"RequestGroup.RelatedAction">> => {<<"BackboneElement">>,
            ...
            {<<"actionId">>, {{primitive, <<"id">>}, required}},
            {<<"relationship">>, {{code, <<"actionrelationshiptype">>}, required}},
            {<<"offest">>, [{<<"offsetDuration">>, {{complex, <<"Duration">>}, optional}},
                {<<"offsetRange">>, {{complex, <<"Range">>}, optional}}]}
            ],
            [],
            [
...
%%
    , <<"ResearchElementDefinition.Characteristic">> => {<<"BackboneElement">>,
            [
            {<<"definition">>, [{<<"definitionCodeableConcept">>, {{complex, <<"CodeableConcept">>}, required}},
                {<<"definitionCanonical">>, {{primitive, <<"canonical">>}, required}},
            ...
            {<<"exclude">>, {{primitive, <<"boolean">>}, optional}},
            {<<"unitOfMeasure">>, {{complex, <<"CodeableConcept">>}, optional}},
            {<<"studyEffective">>, [{<<"studyEffectiveDescription">>, {{primitive, <<"string">>}, optional}},
            ...
            {<<"participantEffective">>, [{<<"participantEffectiveDescription">>, {{primitive, <<"string">>}, optional}},
...
%%
    , <<"ServiceRequest">> => {<<"DomainResource">>,
            ...
            {<<"quantity">>, [{<<"quantityQuantity">>, {{complex, <<"Quantity">>}, optional}},
...
%%
    , <<"TerminologyCapabilities">> => {<<"DomainResource">>,
            ...
            {<<"date">>, {{primitive, <<"dateTime">>}, required}},
            {<<"publisher">>, {{primitive, <<"string">>}, optional}},
            {<<"contact">>, {{metadata, <<"ContactDetail">>}, list}},
            {<<"description">>, {{primitive, <<"markdown">>}, optional}},
            {<<"useContext">>, {{metadata, <<"UsageContext">>}, list}},
            {<<"jurisdiction">>, {{complex, <<"CodeableConcept">>}, list}},
            {<<"purpose">>, {{primitive, <<"markdown">>}, optional}},
            {<<"copyright">>, {{primitive, <<"markdown">>}, optional}},
            {<<"kind">>, {{code, <<"capabilitystatementkind">>}, required}},
